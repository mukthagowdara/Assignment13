...
const RESET_VALUES = {id: '', category: '', price: '', name: '', instock: '', productid: ''}
    ...
    render () {
        return (
            <form>
                ...
                <p>
                    <label>Product Id <br /> 
                    <input type="text" class="form-control" name="productid" onChange={this.handleChange} value={this.state.product.productid} /></label>
                </p>
                <p>
                    <label>Name <br /> 
